...
public class ClientSubmitPublic {
...
//	private static final String YAO_GATEWAY_NEW = "http://common.111yao.com/sltRouter?";
	...
	public static void main(String[] args) throws Exception {
		...
		map.put("memberId", "71998");
		map.put("platform", "3");
		map.put("source", "2");
		map.put("paymentmethodId", "1");
		map.put("receiverId", "1519");
		map.put("deliveryId", "2");
		map.put("isInvoice", "0");
		map.put("remark", "打发似的发射点发谁发的所发生的放大所发生的发生发射点发的说法是东方大厦");
		String YAO_GATEWAY_URL = "http://localhost:8080/111_yao_public/sltRouter";
		System.out.println(ClientSubmitPublic.getPublicService(map,YAO_GATEWAY_URL));
	}
	
	/**
	 * 调用111_public 项目统一方法
	 */
	public static String getPublicService(Map<String, String> sParaTemp,String Url)
		throws Exception {
